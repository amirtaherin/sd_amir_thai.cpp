// =====================================================================================
// amir_v2 (exp017) — cached weights + COALESCED INT32 -> FP32 dequant.
//
// Same pipeline as amir_v1, but the final INT32 -> FP32 dequant uses the
// memory-coalesced kernel (dequantize_i32_to_f32_coalesced_cuda). The original
// dequant was the remaining bottleneck in amir_v1 (~22% GPU time, uncoalesced
// memory access ~5.4 ms/call); the coalesced version is ~1.46 ms/call and made
// this the first custom variant to beat cuBLAS end-to-end.
// =====================================================================================
